...
import AffiliateOrders from '../components/wrappers/AffiliateOrders';
            ...
            <React.Fragment>
                ...
                <Grid container justify="center" className={classes.root}>
                    ...
                    <Grid container item sm={12}>
                        <Grid container item justify="center" alignItems='flex-start' lg={3} md={3} xs={12}>
                            <Route component={UserPanelSettings} />
                        </Grid>
                        <Grid container item justify="center" alignItems='flex-start' lg={9} md={9} xs={12}>
                            <Switch>
                                ...
                                <Route exact path='/affiliate/order' component={AffiliateOrders} />
