...
class ShopCartItem extends Component{
    ...
    render(){
        ...
        const price = fromOrder? item.price : item.sale_price? item.sale_price : item.price;
            ...
            <Grid item xs={12} className={classes.root}>
                ...
                <Grid container justify="center" className={classes.upperSection}>
                    ...
                    <Grid item sm={3} xs={12}>
                            ...
                            {/*<Typography gutterBottom variant='h6' className={classes.textSection}>{globalVariables.LABEL_PRODUCT_COMMISSION[globalVariables.LANG]}: {quantity * commission} {globalVariables.LABEL_CURRENCY[globalVariables.LANG]}</Typography>*/}
                    </Grid>  
                </Grid>
