        ...
        <div className={slider? classes.make3DspaceSlider : classes.make3Dspace}>
            <div className={slider? classes.productCardSlider : classes.productCard}>
                ...
                <div className={slider? classes.productFrontSlider : classes.productFront}>
                    ...
                    :null}
                    <Typography variant='h6' className={slider? classes.productCommSlider : classes.productComm}>{globalVariables.LABEL_PRODUCT_COMMISSION[globalVariables.LANG]} {props.commission} {props.currency}</Typography>
                    {props.tebx?
                        <Typography variant='h6' className={slider? classes.productTebxSlider : classes.productTebx}>
