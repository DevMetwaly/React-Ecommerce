...
const CheckoutSummary = props => {
    ...
    const { classes, totalPrice, /*totalCommission,*/ shipment } = props;
    let shipmentPrice = -1;
    if(shipment !== undefined)
        shipmentPrice = shipment.shipper_id === 1 && totalPrice > 350? 0:shipment.fees;
        ...
        <Grid container justify="center" alignItems="center" className={classes.checkoutSummary}>    
            ...
            <Grid item xs={11}>
                <Grid container>
                    ...
                    <Grid item xs={4}> 
                        <Typography gutterBottom component='h1' variant='h6' className={classes.textSection} style={{fontWeight: 'bold'}}>{totalPrice+(shipmentPrice===-1?0:shipmentPrice)} {globalVariables.LABEL_CURRENCY[globalVariables.LANG]}</Typography>
                    </Grid>
                </Grid>
            </Grid>
            ...
            <Grid item xs={11}>
                <Grid container>
                    {/*<Grid item xs={8}>
                        <Typography gutterBottom component='h1' variant='h6' className={classes.textHead}>{globalVariables.LABEL_PRODUCT_COMMISSION[globalVariables.LANG]}</Typography>
                    </Grid>
                    <Grid item xs={4}> 
                        <Typography gutterBottom component='h1' variant='h6' className={classes.textSection} style={{fontWeight: 'bold'}}>{totalCommission} {globalVariables.LABEL_CURRENCY[globalVariables.LANG]}</Typography>
                    </Grid>*/}
                </Grid>
            </Grid>
