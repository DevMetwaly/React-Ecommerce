                ...
                <MenuList >
                        ...
                        {isAffiliate?
                            <Collapse in={this.state.affiliateOpen} timeout="auto" unmountOnExit>
                                ...
                                <Link to="/affiliate/order" className={classes.link}>
                                    <MenuItem className={classes.nested}>
                                        <ListItemIcon className={classes.icon}>
                                            <PeopleIcon />
                                        </ListItemIcon>
                                        <ListItemText className={classes.primary} inset primary={globalVariables.SETTINGS_SECTION_AFFILIATE_ORDER[globalVariables.LANG]} /> 
                                    </MenuItem>
                                </Link>
