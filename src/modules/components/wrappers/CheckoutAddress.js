...
class CheckoutAddress extends React.Component {
    ...
    handleNextButton = (event, callbackFunction) => {
                ...
                {isLoading ? null :
                    <Grid item xs={12} >
                        <Grid container justify="center" >
                            ...
                            <Button color='primary' variant='contained' style={{ margin: '10px' }} onClick={(event) => this.handleNextButton(event, this.props.handleNextButton)}>
