...
const columns = [
    ...
    { title: 'tbex', field: 'tebx', lookup: {  1:'tbex',  0: 'normal' }, },
]
        ...
        wrappedPromise.promise
            .then(res => {
                res.data.map(item => {
                    ...
                    item.activeIcon = parseInt(item.active) ?
            ...
            <Grid container item justify='center' xs={11}>
                ...
                <Grid container item xs={12}>
                    {isLoading ?
                        ...
                        <CustomMaterialTable title={'منتجاتي'} filtering data={this.state.products} columns={columns} />
                    }
                </Grid>
            </Grid>
        );
