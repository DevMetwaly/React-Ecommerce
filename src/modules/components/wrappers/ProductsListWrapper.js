...
class Store extends Component {
    ...
    fetchAllData = () => {
        ...
        .catch(res => {
            ...
            // console.log('ERROR: Fetching categories failed.', res)
        })
    }
    ...
    fetchProducts = () => {
        ...
        .catch(res => {
            // console.log(`shit ERROR: Fetching products [/${categoryID}/products]`, res, query.page, filtersObject);
            console.log('Error occurred');
        });
    }
    ...
    fetchFilters = () => {
        ...
        try {
            ...
            // console.log('WARNING: Failed to fetch sub-categories.\n', err);
            console.log('Error occurred');
        }
        ...
        categoryAPI.get(`/${categoryID}/specs/count`)
            .then(res => {
                ...
                try {
                    ...
                    // console.log('WARNING: Filters processing failed.\n', err);
                    console.log('Error occurred');
                }
            ...
            .catch(res => {
                // console.log('ERROR: Fetching specs failed.', res)
                console.log('Error occurred');
        });
    }
    ...
    updateFilters = (init = false) => {
        ...
        try {
            ...
            // console.log('WARNING: Filters update failed.\n', err);
            console.log('Error occurred');
        }
    }
